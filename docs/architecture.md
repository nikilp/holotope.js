...
ownership, and accumulation implementation. Inversion barriers, implicit
stiffness handling, and accelerated implementations remain separate policies.
