...
and `'best'` is not simply the most informative available: a positive margin
demotes penetration below shallow contact, because a pair with a skin is meant
to be tested through it.
