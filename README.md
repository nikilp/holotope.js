...
@holotope/physics         headless higher-dimensional mechanics
  ...
  ├─ material geometry    traced StVK + intrinsic mass + source particles + projected XPBD contact
