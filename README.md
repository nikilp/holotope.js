...
- ◐ `@holotope/physics`. **Deformable collision candidates are still authored,
  ...
  plane or one finite persistent source simplex. Mesh self-collision — cloth,
