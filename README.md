...
@holotope/physics         headless higher-dimensional mechanics
  ...
  ├─ material geometry    StVK/Neo-Hookean references + traced assembly + XPBD contact/friction
