...
@holotope/physics         headless higher-dimensional mechanics
  ...
  ├─ compliant geometry   Float64 XPBD distance/simplex constraints + point world + CellComplex compiler
