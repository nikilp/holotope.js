...
@holotope/physics         headless higher-dimensional mechanics
  ...
  ├─ material geometry    traced StVK + intrinsic mass + shared source-particle state + Float64 XPBD
