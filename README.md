...
@holotope/physics         headless higher-dimensional mechanics
  ...
  ├─ material geometry    traced StVK + intrinsic mass + source particles + XPBD contact/friction
