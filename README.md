...
@holotope/physics         headless higher-dimensional mechanics
  ...
  ├─ material geometry    typed StVK/Neo-Hookean assembly + accepted-state guards
