...
@holotope/physics         headless higher-dimensional mechanics
  ...
  ├─ compliant geometry   Float64 XPBD distance, unsigned/signed simplex coordinates + RN point world
